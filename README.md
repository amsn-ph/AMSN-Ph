# AMSN-PH Website V1.4 — Expanded Public Website

This version expands the Phase 1 website using the current AMSN-PH branding, F.Y. 2026–2027 membership memorandum, public AMSN-PH Facebook materials, WITNESS, and AMEN public information.

## New in V1.4

- AMSN + AMEN continuity section
- student → AMSN → graduate/PLE → AMEN pathway
- current Facebook Page and Facebook Group links
- real 8th NEB Turn-Over & Dedicatory Service highlight
- event slideshow/photo gallery support
- WITNESS publication section
- expanded organizational timeline
- 8th NEB event added to Stories & Devotionals

## 8th NEB Highlight

Theme: **Physician in the 11th Hour**  
Date: **July 24, 2026**  
Time: **7:00–8:00 PM PHT**  
...
See `assets/EVENT-PHOTO-INSTRUCTIONS.txt`.
...
5. Membership
6. Programs
7. Chapters / Medical Schools
8. Highlights
9. Stories & Devotionals
...
Please verify with the Board:

- exact official wording of AMSN's organizational relationship with AMEN Philippines
- complete 8th NEB roster
- current chapter list and participating medical schools
- official Mission and Vision
- membership eligibility rules
- final data privacy language
- final domain email address
- approved real stories/devotionals
- official event photos


## V1.5 — Official 8th NEB Turn-Over Gallery

The five supplied event graphics were added **as-is**.

Included:
- `turnover-main-poster.jpg`
- `turnover-program-flow.jpg`
- `turnover-event-recap.jpg`
- `turnover-7th-neb-tribute.jpg`
- `turnover-devotional-highlight.jpg`

The gallery uses `object-fit: contain`, so portrait and landscape graphics remain uncropped. It includes:
- large responsive preview
- image caption/context
- previous/next controls
- clickable thumbnail navigation

The event text was also updated using the supplied official program flow.


## V1.6 — Community hero on homepage

Added a real AMSN-PH online gathering screenshot to the homepage hero area
instead of leaving the hero purely text-based.

Included asset:
- `assets/hero-network-community.jpg`

Design rationale:
- avoids generic stock-medical imagery
- shows the actual AMSN network in action
- communicates that AMSN is a real student community across different schools/regions
- keeps the text readable by using the image as a right-side hero visual rather than a full background



## V1.7 — Replaced hero community photo

Changes:
- Replaced the homepage hero image with the newer uploaded AMSN online gathering screenshot.
- Updated the hero image styling so the image is shown **uncropped**.
- The hero visual now prioritizes full image visibility over edge-to-edge cropping.

Included asset:
- `assets/hero-network-community.jpg`


## V1.8 — Added community/network image section

Added a new full-width section below the homepage hero:

- Section title: `The Network in Action`
- Headline: `Across schools. Across regions. One AMSN-PH.`
- New image asset: `assets/network-community-collage.jpg`

This image is displayed large and uncropped to reduce the text-heaviness of the homepage and better communicate the national/community aspect of AMSN-PH.


## V1.9 — Visual polish

This update keeps the existing AMSN-PH structure and branding, but refines the homepage and section styling.
